<?php
if ( ! function_exists( 'wpems_event_start' ) ) {
	return;
}
?>
    ...
    <div class="entry-summary">
		...
		if ( get_post_type() === 'tp_event' ) {
			if ( ! has_post_thumbnail() ) {
				$feature_image_event = ' tp-default-feature-img';
			}
		}

		echo "<div class='tp-event-top" . $feature_image_event . "'>";
    ...
    <div class="tp-event-content">
        ...
        <div class="tp-event-info">
            <div class="tp-info-box">
                ...
                <p><?php echo wpems_event_start( 'H:i a' ); ?></p>
                <p><?php echo wpems_event_start( 'l, F j, Y' ); ?></p>
            </div>
            <div class="tp-info-box">
                <p class="heading">
                ...
                <p><?php echo wpems_event_end( 'H:i a' ); ?></p>
                <p><?php echo wpems_event_end( 'l, F j, Y' ); ?></p>
            </div>
			...
			<?php if ( wpems_event_location() ): ?>
                <div class="tp-info-box">
                    ...
                    <p><?php echo esc_html( wpems_event_location() ); ?></p>
                </div>
