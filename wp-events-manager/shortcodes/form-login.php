 ...
 * @Last Modified time: 2017-03-30 9:43:34
 */
	...
	<div class="col-xs-12 login-area" id="panel-login">
		...
		<p>
			<?php if ( get_option( 'users_can_register' ) ) : ?>
				<a href="<?php echo esc_attr( wpems_register_url() ); ?>"><?php esc_html_e( 'Register', 'hotel-wp' ) ?></a> |
			<?php endif; ?>
			<a href="<?php echo esc_attr( wpems_forgot_password_url() ); ?>"><?php esc_html_e( 'Forgot Password', 'hotel-wp' ) ?></a>
		</p>
