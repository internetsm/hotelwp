 ...
 * @Last Modified time:   2017-03-30 09:45:18
 */
...
<div class="row thim-auth-login" id="customer_login">
	...
	<div class="col-xs-12 login-area" id="panel-login">
		...
		<p class="text-center">
			<a href="<?php echo esc_url( wpems_login_url() ); ?>"><?php esc_html_e( 'Log in', 'hotel-wp' ); ?></a> |
			<a href="<?php echo esc_url( wpems_forgot_password_url() ); ?>" title="<?php esc_attr_e( 'Password Lost and Found', 'hotel-wp' ) ?>"><?php esc_html_e( 'Lost your password?', 'hotel-wp' ); ?></a>
		</p>
