...
if (!function_exists('thim_woocommerce_catalog_ordering')) {
    function thim_woocommerce_catalog_ordering()
    {
        ...
        $catalog_orderby_options = apply_filters('woocommerce_catalog_orderby', array(
            'menu_order' => esc_html__('Default', 'hotel-wp'),
            'popularity' => esc_html__('Popularity', 'hotel-wp'),
            'rating' => esc_html__('Rating', 'hotel-wp'),
            'date' => esc_html__('Newness', 'hotel-wp'),
            'price' => esc_html__('Price', 'hotel-wp'),
        ));
