					...
					<li data-price="<?php echo esc_attr( $extra->amount_singular ); ?>">
						...
						<div class="hb_extra_optional_left">
							...
							<div class="hb_extra_detail_price">
								...
								<?php endif; ?>
								<label>
									<strong class="price-num"><?php printf( '%s', hb_format_price( $extra->amount_singular ) ) ?></strong>
									<span><?php printf( '/ %s', $extra->respondent_name ? $extra->respondent_name : esc_html__( 'Package', 'hotel-wp' ) ) ?></span>
								</label>
							</div>
						</div>
					</li>
