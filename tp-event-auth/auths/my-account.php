...
if ( !is_user_logged_in() ) {
	printf( esc_html__( 'You are not <a href="%s">login</a>', 'hotel-wp' ), event_auth_login_url() );
	return;
}
?>
		...
		<table class="list-events">
			...
			<?php foreach ( $query->posts as $post ): ?>
				...
				<tr>
					...
					<td><?php printf( '%s', $booking->payment_id ? event_auth_get_payment_title( $booking->payment_id ) : esc_html__( 'No payment.', 'hotel-wp' )  ) ?></td>
