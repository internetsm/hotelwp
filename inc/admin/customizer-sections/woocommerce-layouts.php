...
thim_customizer()->add_field(
    array(
        ...
        'tooltip'       => esc_html__( 'Allows you to choose a layout to display for all woocommerce archive page.', 'hotel-wp' ),
...
thim_customizer()->add_field(
    array(
        ...
        'tooltip'       => esc_html__( 'Allows you to choose a layout to display for only product single page on your site.', 'hotel-wp' ),
        'section'       => 'woocommerce_layout',
        'priority'      => 20,
        'choices'       => array(
            'sidebar-left'     => THIM_URI . 'assets/images/layout/sidebar-left.jpg',
...
thim_customizer()->add_field(
    array(
        ...
        'tooltip'     => esc_html__( 'Allows you to select a sidebar to display in sidebar left when you used Full sidebar layout on product single page.', 'hotel-wp' ),
        'section'     => 'woocommerce_layout',
        'priority'    => 21,
        'multiple'    => 1,
        'choices'     => thim_get_list_sidebar(),
...
thim_customizer()->add_field(
    array(
        ...
        'tooltip'     => esc_html__( 'Allows you to select a sidebar to display in sidebar right when you used Full sidebar layout on product single page.', 'hotel-wp' ),
        'section'     => 'woocommerce_layout',
        'priority'    => 22,
        'multiple'    => 1,
        'choices'     => thim_get_list_sidebar(),
