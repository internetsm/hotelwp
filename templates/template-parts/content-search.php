...
$column = isset( $thim_options['archive_post_column'] ) ? get_theme_mod('archive_post_column') : 2;
	...
	<div class="content-inner">
		...
		<div class="entry-content">
			...
			if ( function_exists('thim_meta') && has_post_format( 'link' ) && thim_meta( 'thim_link_url' ) && thim_meta( 'thim_link_text' ) ) {
				...
				<div class="readmore">
					<a href="<?php echo esc_url( get_permalink() ); ?>"><i class="icomoon icon-up"></i><?php echo esc_html__('Read More','hotel-wp'); ?></a>
				</div><!-- .read-more -->
				...
				<div class="entry-summary">
					<?php if ( $author ) { ?>
						<div class="box-header box-quote">
							<blockquote><?php the_content(); ?><cite><?php echo wp_kses( $author,array( 'a' => array(
										'href' => array(),
									) )); ?></cite>
							</blockquote>
						</div>
